...
declare type HasId = EntityId | HasUUID;
...
type DataSet = [number, any][];

interface DataSetHolder {
  data: DataSet;
}

interface EntityId extends HasUUID {
