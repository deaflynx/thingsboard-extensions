...
import { WidgetService } from '@core/public-api';
import { CdkDragDrop } from '@angular/cdk/drag-drop';
import {
  LabelDataKey,
  labelDataKeyValidator
} from './lem-label-data-key.component';
...
@Component({
  selector: 'lem-flot-widget-settings',
  templateUrl: './lem-flot-widget-settings.component.html',
  styleUrls: ['./widget-settings.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => LemFlotWidgetSettingsComponent),
      multi: true
    },
    {
...
export class LemFlotWidgetSettingsComponent extends PageComponent implements OnInit, ControlValueAccessor, Validator {
